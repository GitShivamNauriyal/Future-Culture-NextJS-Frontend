            ...
            <div className="relative select-none w-full max-w-5xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 px-6">
                {promisesData.map((promise, index) => (
                    <motion.div
                        ...
                        className="relative flex items-start gap-4 p-4 rounded-xl bg-white/5 backdrop-blur-sm hover:backdrop-blur shadow-lg border-l border-b border-red-500/30 hover:border-red-500/50 transition-all duration-500 cursor-pointer"
                    >
                        {/* Glowing Icon Orb */}
