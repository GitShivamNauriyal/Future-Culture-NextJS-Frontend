...
const StatBox = ({ target, label, delay }) => {
    ...
    return (
        <motion.div
            ref={ref}
            className="relative group bg-neutral-800/90 backdrop-blur-sm p-8 rounded-2xl text-center transform hover:-translate-y-1 transition-transform duration-300"
