        ...
        <section id="featured" className="py-20 bg-white overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-6xl font-raleway font-bold text-neutral-900 mb-6 ">
                        Featured
                        <span className="block mt-2 bg-gradient-to-r from-neutral-900 to-neutral-600 bg-clip-text text-transparent">
                            Gift Sets
                        </span>
                    </h2>
                </div>
