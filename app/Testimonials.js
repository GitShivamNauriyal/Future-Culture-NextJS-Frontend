                    ...
                    >
                        {testimonialsData.map((testimonial, index) => (
                            ...
                            <div key={index} className="px-4">
                                <div className="bg-neutral-800 p-8 rounded-xl shadow-sm hover:shadow-xl transition-all duration-300">
                                    <div className="flex items-center mb-6">
                                        <div className="w-12 h-12 bg-gradient-to-br from-neutral-300 to-neutral-50 rounded-full flex items-center justify-center text-black">
